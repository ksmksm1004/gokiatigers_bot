...
| `/최근경기` | `/recentgames` | 완료된 KIA 경기 중 최근 4개 상대 팀 시리즈의 스코어와 승패 |
...
`/최근경기` 또는 `/recentgames`를 입력하면 현재 시즌의 완료된 KIA 경기를 상대 팀이 바뀌는 시점마다 시리즈로 묶어 최근 4개를 표시합니다. 스코어는 원정팀:홈팀 순서이고 승·무·패는 KIA 기준입니다. 취소 경기와 아직 끝나지 않은 경기는 포함하지 않습니다.
